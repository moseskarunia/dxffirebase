    ...
    parseLtype(data){
        ...
        return new Promise((resolve, result)=>{
           Promise.each(data, (cursor)=>{
               ...
               if(ltypeBuffer && ltypeBuffer.hasOwnProperty('name')) ltype[ltypeBuffer.name] = ltypeBuffer;
               resolve(ltype)
           })
        });
    }
    ...
    parseLayer(data){
        ...
        return new Promise((resolve, result)=>{
            Promise.each(data, (cursor)=>{
                ...
                if(layerBuffer && layerBuffer.hasOwnProperty('name')) layer[layerBuffer.name] = layerBuffer;
                resolve(layer)
            })
        });
    }
